  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white"> CloudVikings ☁️</a></h4>
    ...
    <div class="container container--narrow">
        <div class="alert alert-danger text-center"> <!-- To change the message color to red, use alert-danger instead of alert-success -->
          {{session('failure')}}
        </div>
    </div>
    @endif
    ...
    <footer class="border-top text-center small text-muted py-3">
     <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">CloudVikings ☁️</a>. All rights reserved.</p>
    </footer>
